...
// 环境变量
const UUID = process.env.UUID || 'a2056d0d-c98e-4aeb-9aab-37f682d71710'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'EqNhUYpb9uKXL4bzPIrjeHiz7n0Z1w6M';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
